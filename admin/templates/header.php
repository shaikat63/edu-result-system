    ...
    <section class="vbox">
        <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
            ...
            <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="users_photo/<?php echo $_SESSION['pic']; ?>" alt="..."> </span><?php echo $_SESSION['name'] ; ?><b class="caret"></b> </a>
                    <ul class="dropdown-menu animated fadeInRight">
                        ...
                        <li class="divider"></li>
                        <li> <a href="inc/logout.php" data-toggle="ajaxModal">Logout</a> </li>
                    </ul>
                </li>
            </ul>
        </header>
                        ...
                        <section class="w-f scrollable">
                            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                <div class="clearfix wrapper dk nav-user hidden-xs">
                                    <div class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb avatar pull-left m-r"> <img src="users_photo/<?php echo $_SESSION['pic']; ?>" class="dker" alt="..."> <i class="on md b-black"></i> </span> <span class="hidden-nav-xs clear"> <span class="block m-t-xs"> <strong class="font-bold text-lt"><?php echo $_SESSION['name'] ; ?></strong> <b class="caret"></b> </span> <span class="text-muted text-xs block"><?php echo $_SESSION['email']; ?></span> </span>
                                        </a>
                                ...
                                <nav class="nav-primary hidden-xs batch268">
                                    ...
                                    <ul class="nav nav-main" data-ride="collapse">
                                        ...
                                        <li>
                                            ...
                                            <ul class="nav dk">
                                                <li>
                                                    <a href="all_student.php" class="auto"> <i class="i i-dot"></i> <span>All Students</span> </a>
                                                </li>
                                                <li>
                                                    <a href="add_new_sudent.php" class="auto"> <i class="i i-dot"></i> <span>Add Student</span> </a>
                                                </li>
